...
class StudentCardWidget extends GetView<DashboardController> {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      CommonButton(
        onTap: () {
          controller.onSelectStudent();
        },
        name: "Stations",
      ).paddingOnly(
          left: AppUtils.isTab() ? Dimens.gapX15 : Dimens.gapX8,
          right: AppUtils.isTab() ? Dimens.gapX15 : Dimens.gapX8)
    ]);
  }
}
