...
class StationEStepper extends GetView<StationEController> {
  const StationEStepper({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Dimens.heightGap1,
        subHeading(
            text: 'Skeleton, Muscles & Nerves', textColor: AppColors.baseColor),
        Dimens.heightGap2,
        Obx(
          () => Center(
            child: CustomStepper(
