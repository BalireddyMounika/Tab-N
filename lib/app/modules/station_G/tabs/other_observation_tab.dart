...
import '../controllers/other_observations_controller.dart';

class OtherObservationsTab extends GetView<OtherObservationsController> {
  const OtherObservationsTab({Key? key}) : super(key: key);
                    ...
                    Obx(
                      () => Column(
                        ...
                        children: List.generate(
                          controller.referralTypeList.length,
                          (i) => CommonCheckBox(
                            isActive: controller.isSpecialistReferralNeeded.value,
                            checkedIcon: Icons.check_box,
                            unCheckedIcon: Icons.check_box_outline_blank,
                            onTap: () {
                              if (controller.selectedReferralType
                                  .contains(controller.referralTypeList[i])) {
                                controller.selectedReferralType
                                    .remove(controller.referralTypeList[i]);
                              } else {
