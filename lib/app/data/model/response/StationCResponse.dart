class StationCResponse {
  ...
  StationCResponse.fromJson(dynamic json) {
    id = json['id'];
    hcid = json['HCID'];
    hcpid = json['HCPID'];
    uin = json['UIN'];
  ...
  String? visualAcuity;
  String? visualAcuityWithLensesDistantVisionLeft;
  String? visualAcuityWithLensesDistantVisionRight;
  String? visualAcuityWithLensesNearVisionLeft;
  String? visualAcuityWithLensesNearVisionRight;
  String? visualAcuityWithoutLensesDistantVisionLeft;
  String? visualAcuityWithoutLensesDistantVisionRight;
  String? visualAcuityWithoutLensesNearVisionLeft;
  String? visualAcuityWithoutLensesNearVisionRight;
